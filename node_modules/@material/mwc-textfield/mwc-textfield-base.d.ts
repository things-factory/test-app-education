...
export declare abstract class TextFieldBase extends FormElement {
    ...
    protected renderHelperText(charCounterTemplate?: TemplateResult): TemplateResult;
    protected renderCharCounter(): TemplateResult;
    ...
    protected onLabelChange(): Promise<void>;
    layout(): Promise<void>;
}
