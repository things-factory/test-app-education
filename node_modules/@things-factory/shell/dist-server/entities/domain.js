...
Domain = __decorate([
    typeorm_1.Entity('domains'),
    typeorm_1.Index('ix_domain_0', (domain) => [domain.name], { unique: true }),
    typeorm_1.Index('ix_domain_1', (domain) => [domain.subdomain]),
    typeorm_1.Index('ix_domain_2', (domain) => [domain.systemFlag])
], Domain);
