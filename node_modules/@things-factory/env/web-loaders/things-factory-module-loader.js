...
const dependencyOrders = require("./lib/dependency-order");
...
module.exports = async function(content) {
  ...
  var modulePath = options.module_path
    ? options.module_path
  ...
  try {
    ...
    console.warn(
      "[things-factory-module-loader]",
      "@things-factory module folder not found."
    );
  }
